...
| 4 | `IndexController` | Index page element coordination |
| 5 | `ShowController` | Show page element coordination |
| 6 | `FormController` | Form record initialisation and `form_element` setup |
| 7 | `BatchController` | Batch-action support between index and processing actions |
| 8 | `ActionsController` | Default handlers for router-generated actions (e.g. `search`) |
| 9 | `WidgetsController` | Widget data helpers for index and dashboard pages |
...
| `elements` | Element DSL access (menus, forms, etc.) |
