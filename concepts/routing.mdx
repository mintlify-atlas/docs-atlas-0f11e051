...
description: "Explore Torque Admin's routing DSL — the admin helper, resource declarations, dashboard routes, sections, widgets, custom actions, and auth hooks."
---
...
| `action:` | `nil` | Override the controller action name for the route |
